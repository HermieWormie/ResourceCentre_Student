...
public class ResourceCentreTest {
	...
	public void testDoLoanCamcorder() {
		// fail("Not yet implemented");
		// write your code here
		assertNotNull("Test if Camcorder arraylist is not null so that items can be loaned", camcorderList);
		...
		allCamcorder = ResourceCentre.retrieveAllCamcorder(camcorderList);
		testOutput = String.format("%-10s %-30s %-10s %-10s %-20d\n", "CC0011", "Nikon HDSLR", "Yes",
				camcorderList.get(0).getDueDate(), 40);
		testOutput += String.format("%-10s %-30s %-10s %-10s %-20d\n", "CC0012", "Sony DSC-RX100M7", "Yes",
				camcorderList.get(1).getDueDate(), 20);
		assertEquals("Test", testOutput, allCamcorder);

		ResourceCentre.doLoanCamcorder(camcorderList, "CC0011", camcorderList.get(0).getDueDate());
		ResourceCentre.doLoanCamcorder(camcorderList, "CC0012", camcorderList.get(1).getDueDate());
	...
	public void testDoLoanChromebook() {
		// fail("Not yet implemented");
		// write your code here
		assertNotNull("Test if Chromebook arraylist is not null so that items can be loaned", chromebookList);
		...
		testOutput += String.format("%-10s %-30s %-10s %-10s %-20s\n", "CB0012", "SAMSUNG Chromebook 4+", "Yes", "",
				"Win 10");
		assertEquals("Check that ViewAllchromebookListlist", testOutput, allChromebook);
		...
		testOutput += String.format("%-10s %-30s %-10s %-10s %-20s\n", "CB0012", "SAMSUNG Chromebook 4+", "Yes", "",
				"Win 10");
		assertEquals("Test", testOutput, allChromebook);

		ResourceCentre.doLoanChromebook(chromebookList, "CB0011", chromebookList.get(0).getDueDate());
		ResourceCentre.doLoanChromebook(chromebookList, "CB0012", chromebookList.get(1).getDueDate());
